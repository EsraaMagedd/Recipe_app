                      ...
                      children: [
                        Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.asset("images/mulukhiyah.png",
                                fit: BoxFit.cover,
                              ),
                            )
                        ),
...
- A quarter cup of oil''', style: const TextStyle(
                        fontSize: 20,
                        fontWeight: FontWeight.bold,
                        color: Colors.black,
                ...
                SizedBox(height: 20,),
                InkWell(
                  onTap: () => launch("https://www.youtube.com/watch?v=hfh9hsJkUYc"),
                  child: Stack(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage("images/mulukhiyah.png"),
                              fit: BoxFit.cover,
                            ),
                            boxShadow: [
                              BoxShadow(
